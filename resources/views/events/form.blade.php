<form class="form-horizontal" action="{{ $form['url'] }}" method="{{ $form['method'] }}">
    ...
    <div class="form-group{!! ($errors->has('title')) ? ' has-error' : '' !!}">
        <label class="col-md-2 col-sm-3 col-xs-10 control-label" for="title">活动标题</label>
    ...
    <div class="form-group{!! ($errors->has('location')) ? ' has-error' : '' !!}">
        <label class="col-md-2 col-sm-3 col-xs-10 control-label" for="location">活动区域</label>
        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
    ...
    <div class="form-group{!! ($errors->has('date')) ? ' has-error' : '' !!}">
        <label class="col-md-2 col-sm-3 col-xs-10 control-label" for="date">截止时间</label>
        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
    ...
    <div class="form-group{!! ($errors->has('body')) ? ' has-error' : '' !!}">
        <label class="col-md-2 col-sm-3 col-xs-10 control-label" for="body">活动内容</label>
